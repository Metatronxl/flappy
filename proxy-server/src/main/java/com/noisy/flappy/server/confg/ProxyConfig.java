package com.noisy.flappy.server.confg;

import com.google.gson.reflect.TypeToken;
import com.noisy.flappy.common.Config;
import com.noisy.flappy.common.JsonUtil;
...
public class ProxyConfig implements Serializable {
    ...
    static {
        // 代理配置信息存放在用户根目录下
        String dataPath = System.getProperty("user.home") + "/" + ".flappy/";
     ...
     * 解析配置文件
     *
     * @param proxyMappingConfigJson
     */
    public void updatae(String proxyMappingConfigJson) {
